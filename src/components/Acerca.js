...
export default (props) => {
    return (
        <div className="pl-4 pt-4" >
            ...
            <p className="comment"><span className="codeWhite ml-2 invisible md:visible">6</span><a href="https://github.com/RodrigoRMG/imdeveloper" target="blank">https://github.com/RodrigoRMG/imdeveloper</a></p>
